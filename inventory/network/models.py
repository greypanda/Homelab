...
class Device(models.Model):
    ...
    osfamily = models.CharField(max_length=128,blank=True,null=True)
    osname = models.CharField(max_length=128,blank=True,null=True)
    ostype = models.CharField(max_length=128,blank=True,null=True)
    osvendor = models.CharField(max_length=128,blank=True,null=True)
    ports = models.TextField(blank=True,null=True)
    location = models.CharField(max_length=128,default="Unkknown")
    ...
    ansible_group = models.CharField(max_length=32,blank=True,null=True)
    dns_group = models.CharField(max_length=32,blank=True,null=True)
